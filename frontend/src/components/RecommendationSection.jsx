				...
				{recommendations.map(r => (
					...
					>
						...
						<div className='p-4 flex flex-col flex-1 min-h-0'>
							...
							<div className='flex gap-1 mb-3 overflow-x-auto whitespace-nowrap pb-1'>
								{r.amenities.map(a => (
									<span
										key={a}
										className='shrink-0 text-[9px] font-bold bg-black/[0.04] dark:bg-white/[0.05] text-slate-500 dark:text-slate-400 px-2 py-0.5 rounded border border-black/[0.04] dark:border-white/[0.04] uppercase tracking-wider'
									>
										{a}
									</span>
								))}
